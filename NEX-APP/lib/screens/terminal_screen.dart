...
''');
      ...
      case 'status':
        ...
        _addOutput('info', '  • FIREBASE_SOC: CONNECTED');
      ...
      case 'whoami':
        _addOutput('info', 'IDENTITY: user_alpha_42');
        _addOutput('info', 'ACCESS_LVL: PREMIUM_ROOT');
        break;
  ...
  Color _getTypeColor(String type) {
    switch (type) {
      case 'command': return kNeonBlue;
      case 'success': return kNeonGreen; // Distinct success color
      case 'error': return Colors.redAccent;
      case 'warning': return Colors.amber;
      case 'live': return Colors.lightGreenAccent.withValues(alpha: 0.7);
      case 'info': return kNeonBlue.withValues(alpha: 0.8);
      case 'welcome': return kNeonBlue;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(colors: [kNeonBlue, Color(0xFF3B82F6)]),
                borderRadius: BorderRadius.circular(8),
                boxShadow: [
                  BoxShadow(color: kNeonBlue.withValues(alpha: 0.3), blurRadius: 10),
                ],
              ),
            ...
            const Text(
                'NEX_TERMINAL',
                style: TextStyle(color: Colors.white, fontFamily: 'monospace', fontWeight: FontWeight.w900, fontSize: 14, letterSpacing: 1)
            ),
          ],
        ),
        leading: IconButton(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.layers_clear_rounded, color: kNeonBlue, size: 20),
            onPressed: () {
              setState(() => _output.clear());
        ...
        children: [
          ...
          Container(
            ...
            child: SafeArea(
              child: Row(
                children: [
                  const Text('\$ ', style: TextStyle(color: kNeonBlue, fontSize: 16, fontFamily: 'monospace', fontWeight: FontWeight.w900)),
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: _startupComplete ? 'Awaiting command...' : 'SYS_BOOTING...',
                  ...
                  if (_startupComplete)
                    Opacity(
                      ...
                      child: Container(width: 8, height: 18, color: kNeonBlue.withValues(alpha: 0.8)),
                    ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.subdirectory_arrow_left_rounded, color: kNeonBlue, size: 20),
                    ),
                  ),
                ],
              ),
