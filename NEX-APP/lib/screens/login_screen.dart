                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: RadialGradient(colors: [kNeonGreen.withValues(alpha: 0.35), Colors.transparent]),
                    ),
                  ),
                ),
                Positioned(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                const Text('Forgot password? ', style: TextStyle(color: Colors.white54, fontSize: 13)),
                                GestureDetector(
                                  onTap: () => Navigator.pushNamed(context, '/reset-password'),
                                  child: const Text(
                                    'Reset it',
                                    style: TextStyle(color: Color(0xFF00B8F4), fontSize: 13, fontWeight: FontWeight.bold),
                                  ),
                                ),
                              ],
                            ),
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                const Text('New to NEXCHAT? ', style: TextStyle(color: Colors.white54, fontSize: 13)),
                                GestureDetector(
